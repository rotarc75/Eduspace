        ...
        <div className="card">
          ...
          <div className="form-stack">
            <div className="form-group">
              ...
              <input type="password" placeholder="••••••••" value={pwd} onChange={e => { setPwd(e.target.value); setMsg(null) }} />
            </div>
            <div className="form-group">
            ...
            {msg && <div style={{ fontSize: 13, color: msg.type === 'error' ? 'var(--red)' : 'var(--green)', fontWeight: 500 }}>{msg.text}</div>}
